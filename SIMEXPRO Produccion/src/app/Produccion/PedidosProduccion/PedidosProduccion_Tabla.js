...
export default function PedidosProduccion_Tabla() {
            ...
            <Grid>
                <TableContainer>
                    ...
                    <TableHead>
                        ...
                        <TableCell onClick={() => handleRequestSort('Empleado')}>
                        Empleado
                            {orderBy === 'Empleado' ? (
                                <span>{order === 'desc' ? ' ▼' : ' ▲'}</span>
                            ) : null}
                        </TableCell>
                        <TableCell onClick={() => handleRequestSort('Fecha de emision')}>
                        Fecha de emision
                            {orderBy === 'FechaEntrada' ? (
                                <span>{order === 'desc' ? ' ▼' : ' ▲'}</span>
                            ) : null}
                        </TableCell>
                        <TableCell onClick={() => handleRequestSort('Estado de pedido')}>
                        Estado de pedido
