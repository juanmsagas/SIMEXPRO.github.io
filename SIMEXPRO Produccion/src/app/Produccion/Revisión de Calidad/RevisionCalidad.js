              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={6}>
                  <FormControl fullWidth>
                    <TextField
                      style={{ borderRadius: '10px', marginTop: '23px', borderColor: isCantidadValid ? 'initial' : 'red' }}
                      label="Cantidad"
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                  ...
                  <FormControl fullWidth>
                    <TextField
                      style={{ borderRadius: '10px', marginTop: '25px', borderColor: isFechaRevisionValid ? 'initial' : 'red' }}
